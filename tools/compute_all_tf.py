...
def KDETensor(img_fs, sigma):
    return tf.exp(-tf.div(img_fs, tf.square(sigma)))
...
if __name__ == '__main__':
    with tf.Session() as sess:
        with tf.device("/gpu:0"):
            ...
            np.save('imgDistance_training.npy', dis_training.eval())
            ...
            kde_all = KDETensor(dis_training, sigma_training)
